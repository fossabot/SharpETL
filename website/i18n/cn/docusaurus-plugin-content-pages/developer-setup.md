...
- \[Recommended\] We have embraced the code style largely based on [google format](https://google.github.io/styleguide/javaguide). Please setup your IDE with style files from [\<project root\>/style/](https://github.com/SharpData/SharpETL/tree/master/style). These instructions have been tested on IntelliJ.
...
### Contributing Code
 ...
 - Make your code change
   ...
   - If your code change changes some aspect of documentation (e.g new config, default value change), 
     please ensure there is another PR to [update the docs](https://github.com/SharpData/SharpETL/tree/asf-site/README.md) as well.
...
## Releases
 ...
 - Sharp ETL community plans to do minor version releases every 6 weeks or so.
...
[Sharp ETL site](https://hudi.apache.org) is hosted on a special `asf-site` branch. Please follow the `README` file under `docs` on that branch for
